                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-auto">
                                        <div class="chart-wrapper mt-1">
                                            <canvas id="profitchart" class="chart-dropshadow"></canvas>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-auto">
                                        <div class="chart-wrapper mt-1">
                                            <canvas id="costchart" class="chart-dropshadow"></canvas>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalToggleLabel">Ajouter Niveaux
                                                </h5>
                                                ...
                                                <form action="{{ route('niveaux.store') }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <input type="text" name="nom" class="form-control"
                                                            placeholder="Exemple : Baccalauréat" required>
                                                    </div>
                                    ...
                                    @foreach($niveaux as $niveau)
                                        <li class="d-sm-flex">
                                            <div>
                                                ...
                                                <h6 class="fw-semibold">{{ $niveau->nom }}<span
                                                        class="text-muted fs-11 mx-2 fw-normal">{{ $niveau->created_at->format('d M Y') }}</span>
                                                </h6>
                                            </div>
