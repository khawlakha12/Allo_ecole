        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="page-header">
                  <h1 class="page-title my-auto">To Do List</h1>
                  <div>
                            ...
                            <div class="card custom-card">
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-3 text-center">
                                        <img src="../assets/images/media/media-65.png" alt="img" class="wd-150">
                                    </div>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-between">
                                                            <div>
                                                                ...
                                                                <p class="mb-3">Status : <span class="badge bg-secondary">Inprogress</span></p>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex justify-content-between">
                                                            <div>
                                                                ...
                                                                <p class="mb-3">Status : <span class="badge bg-danger">pending</span></p>
                                                                <p class="mb-0">Assigned To :</p>
                                                                <span class="avatar-list-stacked ms-1">
                                                                    <span class="avatar avatar-sm avatar-rounded">
                                                                        <img src="../assets/images/faces/2.jpg" alt="user-img">
