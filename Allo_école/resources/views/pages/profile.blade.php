                                    ...
                                    <div class="rbt-header-top-news">
                                        <div class="inner">
                                            <div class="content">
                                                ...
                                                <span class="news-text"><img src="assets_pages/images/icons/hand-emojji.svg" alt="Hand Emojji Images"> Intro price. Get Histudy for Big Sale -95% off.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="header-info">
                                    <ul class="rbt-dropdown-menu switcher-language">
                                        <li class="has-child-menu">
                                            <a href="#">
                                                <img class="left-image" src="assets_pages/images/icons/en-us.png" alt="Language Images">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="assets_pages/images/icons/fr.png" alt="Language Images">
                                                        <span class="menu-item">Français</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image" src="assets_pages/images/icons/de.png" alt="Language Images">
